        ...
        <b-container>
            ...
            <b-row class="mt-2">
              <b-col>
                <p>
                 ...
                 <ul>
                    <li>
                      A new Metro fleet which will transform the journey experience, be 20 times more reliable but
                      use 30% less energy than current trains.
                    </li>
                    <li>
                      The £104m Metro Flow project, upgrading lines to make trains more frequent, create space for
                      up to 30,000 more passengers and deliver smoother and shorter journey times.
                    </li>
                    <li>
                      Continued investment in Metro’s behind-the-scenes technology and infrastructure including
                      power lines, track and signal systems.
                    </li>
                    <li>
                      Building business cases to expand the reach of Metro with new stations and routes as we look
            ...
            <b-row>
              <b-col>
                ...
                <p>
                  Construction of the Tyne and Wear Metro began in 1974, and the first part of the system opened in
            ...
            <b-row>
              <b-col>
                ...
                <p>
                  There are few people living in Tyne and Wear whose daily lives are not touched in some way by
                ...
                <p>
                  Nexus owns and operates Metro as a public service. Beyond this it provides, plans and promotes all public transport to improve the economic prosperity of Tyne and Wear, and the daily lives of its people. 
                </p>

                <p>
                  Nexus is the Tyne and Wear Passenger Transport Executive and administers funds on behalf of North East England’s two combined authorities. Our task is to improve the quality  life and fortunes of everyone in Tyne and Wear, by creating better transport networks. 
                </p>
              </b-col>
            </b-row>
            <b-row>
            ...
            <b-row>
              <b-col>
                ...
                <p>
                  <a target="blank" href="https://openlab.ncl.ac.uk/">Open Lab</a> is an interaction design and ubiquitous computing research group at Newcastle University.
                </p>
                
                <p>
                  We are more than just researchers. We are designers, collaborators, artists, educators, programmers, engineers, psychologists, data geeks and more. From the Internet of Things (IoT) to inclusive design, we create technologies to solve real world problems using human-centred design.
                </p>
                
                <p>
                  In just over a decade we have become a world-leading research group working at the cutting edge of Human-Computer Interaction (HCI), Design Futures and Digital Social. Our work addresses the grand challenges of social and environmental sustainability, and future living, through the design of innovative digital technologies. 
                </p>
              </b-col>
            </b-row>
